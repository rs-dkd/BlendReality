Shader "Custom/HiddenLineOpaque" // Renamed for clarity
{
    Properties
    {
    ...
    SubShader
    {
        // Tags changed to Opaque
        Tags { "RenderType" = "Opaque" "Queue" = "Geometry" "RenderPipeline" = "UniversalPipeline" }

        Pass
        {
            // Blend line removed
            ZWrite On // Changed from Off
            Cull Off

            Name "HiddenLine Pass"
            ...
            half4 frag(g2f i, float facing : VFACE) : SV_Target
            {
                ...
                // faceColor line modified to remove _FaceAlpha
