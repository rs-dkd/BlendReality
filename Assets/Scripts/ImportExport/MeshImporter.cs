...
public class MeshImporter : MonoBehaviour
{
    ...
    public Vector3 defaultImportPosition = new Vector3(0, 1, 2);
    public Vector3 defaultImportScale = Vector3.one;
    ...
    {
        GameObject tempObj = LoadObjDirectly(path);

        if (tempObj != null)
        {
            ProcessImportedObjectDirect(tempObj, name, combineMesh);

            CreateImportedObject(0);
        }
