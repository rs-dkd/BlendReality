...
public class SnappingGrabTransformer : XRGeneralGrabTransformer
{
    ...
    {
        snapSpace = ModelEditingPanel.Instance.currentGizmoSpace;
    }
    ...
    public override void Process(XRGrabInteractable grabInteractable, XRInteractionUpdateOrder.UpdatePhase updatePhase, ref Pose targetPose, ref Vector3 localScale)
    {
        ...
        // 1. First, call the base method to get the unsnapped target pose.
        base.Process(grabInteractable, updatePhase, ref targetPose, ref localScale);

        // 2. Apply our custom snapping logic to the calculated pose.
        ...
        // Instead of checking localScale.HasValue, we check if more than one
        // interactor (hand) is selecting the object, which is how scaling is activated.
